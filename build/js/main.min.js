...
var getCarousel = function getCarousel() {
  ...
  for (var i = 0; i < carouseItem.length; i++) {
    if (carouseItem[i] === 0) {
...
var sliderItems = document.querySelector('[data-element="slider__item"]'); // const cards = document.querySelectorAll('[data-element="card"]');
...
var getInfo = function getInfo() {
  for (var i = 0; i < sliderItems.length; i++) {
    ...
    sliderItems[i].addEventListener('focus', function (evt) {
      ...
      var sliderItem = evt.target.closest('[data-element="card"]');
      sliderItem.classList.add('is-active');
    });
  }
