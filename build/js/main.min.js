...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_coaches_slider_js__WEBPACK_IMPORTED_MODULE_4__["getSlider"])();
  Object(_modules_carousel_js__WEBPACK_IMPORTED_MODULE_5__["getCarousel"])(); // Modules
  // ---------------------------------
...
var prevToggle = document.querySelector('[data-element="prev"]');
var nextToggle = document.querySelector('[data-element="next"]');
var sliderCoach = document.querySelector('[data-element="slider"]');
var slideWidth = document.querySelector('[data-element="slider__item"]').getBoundingClientRect().width;

var getSlider = function getSlider() {
  var slideLength = sliderCoach.querySelectorAll('[data-element="slider__item"]').length;
  var now = 0;
  var sliderOffset = [];
...
var videoPlayer = document.querySelector('.js-videoPoster');
